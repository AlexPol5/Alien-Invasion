...
def check_keydown_events(event, ai_settings, stats, sb, screen, ship, aliens,
    ...
    if event.key == pygame.K_RIGHT:
        ...
        # рекорда и выводит на экран.
        # Запись рекорда в файл.
        with open('high_record.txt', 'w') as file_object:
...
def start_game(ai_settings, screen, stats, sb, ship, aliens,
    ...
    # Сброс изображений текущего счета, рекорда, уровня игры
    # и оставшихся жизней (кораблей).
    sb.prep_score()
    sb.prep_high_score()
    sb.prep_level()
    sb.prep_ships()
...
def ship_hit(ai_settings, stats, screen, sb, ship, aliens, bullets):
    """Обрабатывает столкновения корабря с пришельцем."""
