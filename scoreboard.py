...
class Scoreboard():
    ...
    def prep_images(self):
        """
        Подготавливает изображения текущего счета, рекорда,
        уровня игры и оставшихся жизней (кораблей).
        """
    ...
    def prep_high_score(self):
        ...
        # Рекорд выравнивается по центру нижней стороны.
        self.high_score_rect = self.high_score_image.get_rect()
        self.high_score_rect.centerx = self.screen_rect.centerx
        self.high_score_rect.top = self.score_rect.top

    def prep_level(self):
        """Преобразуе уровень в графическое изображение."""
